...
class FoodView extends GetView<FoodController> {
  ...
  Widget _buildFoodGrid() {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final String title = food['title'] as String;
        return Obx(() {
  ...
  Widget _buildFoodCard(Map<String, dynamic> food, bool isSelected) {
    final String title = food['title'] as String;
    return InkWell(
                ...
                Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${(food['price'] as double).toStringAsFixed(0)} F',
                        style: TextStyle(
            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final food = controller.foods.firstWhere(
                    (f) => f['title'] == title,
                  );
                  return _buildOrderItem(title, qty, food['price'] as double);
                },
              );
            }),
          ),
